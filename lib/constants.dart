...
class kRoutes {
  ...
  static const registrationRoute = 'registrationRoute';
...
const kkeyboard = TextInputType.emailAddress;
const ktextAlignment = TextAlign.center;
const kpasswordtxt = true;
